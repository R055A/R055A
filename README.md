...
<!-- 2x proud Hacktoberfest tree parent 🌲🤗☕. Not quite Oktoberfest, but could be both one day. -->
...
> _My **Avg contributions** mostly include [uni projects](https://github.com/University-Project-Repos), and exclude non-collab/solo, minor roles (open-source, lead), etc_
