...
> _My **Avg (`.git`) contributions** mostly include [uni projects](https://github.com/University-Project-Repos), and exclude non-collab/solo, minor roles (open-source, lead), etc_
