...
_recovering from severe injuries (including total amnesia, paralyses, internals, sense, stab/projectile/foreign-body, & now years of multiple infections head-to-toe corresponding with device damages, etc, etc, etc) & epic_ 🌎 _24/7 plagues (since childhood_ 🤷)
